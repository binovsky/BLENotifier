...
{
    _ASSERT( !_rootController );
    _rootController = [[RootController alloc] init];
    [_rootController loadView];
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"OSX_BLENotifier" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *url = [applicationFilesDirectory URLByAppendingPathComponent:@"OSX_BLENotifier.storedata"];
